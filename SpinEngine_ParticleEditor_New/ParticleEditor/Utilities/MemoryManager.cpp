...
ObjectAllocator* MemoryManager::GameObj_OA = 0;
//ObjectAllocator* MemoryManager::System_OA[System_Count] = { 0 };
ObjectAllocator* MemoryManager::Component_OA[Component_Count] = { 0 };
