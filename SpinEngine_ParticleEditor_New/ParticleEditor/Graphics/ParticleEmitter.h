...
{
public:
  ParticleEmitter(GameObject Owner, IDirect3DDevice9* device, emitter_types type = ET_NORMAL, blend_types b_type = BT_ADD,
  ...
  bool use_source_factor;
  bool use_dest_factor;
