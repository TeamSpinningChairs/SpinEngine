...
//(z-axis is ignored)
float MathF::ApproxATan(Vector3 input)
{
...
Vector3 MathF::RotateAroundPoint(Vector3 origin, float radAngle, Vector3 start)
{
  //cos a -sin a    x
  //sin a cos a     y
  start -= origin;
...
Vector3 MathF::ApproxRotateAroundPoint(Vector3 origin, float radAngle, Vector3 start)
{
  //cos a -sin a    x
  //sin a cos a     y
  start -= origin;
