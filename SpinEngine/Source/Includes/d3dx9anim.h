...
// translation keys.
//----------------------------------------------------------------------------
typedef struct _D3DXKEY_Vector3D
{
    FLOAT Time;
    D3DXVECTOR3 Value;
} D3DXKEY_Vector3D, *LPD3DXKEY_Vector3D;
...
DECLARE_INTERFACE_(ID3DXKeyframedAnimationSet, ID3DXAnimationSet)
{
	...
	STDMETHOD(GetScaleKeys)(THIS_ UINT Animation, LPD3DXKEY_Vector3D pScaleKeys) PURE;
	STDMETHOD(GetScaleKey)(THIS_ UINT Animation, UINT Key, LPD3DXKEY_Vector3D pScaleKey) PURE;
	STDMETHOD(SetScaleKey)(THIS_ UINT Animation, UINT Key, LPD3DXKEY_Vector3D pScaleKey) PURE;
	...
	STDMETHOD(GetTranslationKeys)(THIS_ UINT Animation, LPD3DXKEY_Vector3D pTranslationKeys) PURE;
	STDMETHOD(GetTranslationKey)(THIS_ UINT Animation, UINT Key, LPD3DXKEY_Vector3D pTranslationKey) PURE;
	STDMETHOD(SetTranslationKey)(THIS_ UINT Animation, UINT Key, LPD3DXKEY_Vector3D pTranslationKey) PURE;
    ...
    STDMETHOD(RegisterAnimationSRTKeys)(THIS_ 
        ...
        CONST D3DXKEY_Vector3D *pScaleKeys,              // Array of scale keys
        CONST D3DXKEY_QUATERNION *pRotationKeys,        // Array of rotation keys
        CONST D3DXKEY_Vector3D *pTranslationKeys,		// Array of translation keys
