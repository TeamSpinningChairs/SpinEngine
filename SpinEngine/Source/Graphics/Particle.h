...
{
public:
  Particle(Vector3D initial_pos = Vector3D(), float lifespan = 1.0f);
  ~Particle();
  ...
  //NORMAL
  void run_particle(float dt, float p_lifetime, float lifetime_invariant, Vector3D pos, float ang_1 = 90.0f, float ang_2 = 90.0f,
    float spd1 = 1.0f, float spd2 = 4.0f, float acc1 = 1.0f, float acc2 = 20.0f, float spin = 0.0f, float spin_invariance = 0.0f);
  void reset_particle(Vector3D pos, float p_lifetime, float ang_1 = 90.0f, float ang_2 = 90.0f,
    float spd1 = 1.0f, float spd2 = 4.0f, float acc1 = 1.0f, float acc2 = 20.0f, float new_spin = 0.0f);

  //SQUARE
  void run_particle_square(float dt, float p_lifetime, float lifetime_invariant, Vector3D pos, float width = 1.0f, float height = 1.0f,
  ...
  void reset_particle_square(Vector3D pos, float p_lifetime, float width = 1.0f, float height = 1.0f,
    float spd1 = 1.0f, float spd2 = 4.0f, float acc1 = 1.0f, float acc2 = 20.0f, float angle = 0.0f, float new_spin = 0.0f);

  //DIAMOND
  void run_particle_diamond(float dt, float p_lifetime, Vector3D pos, float width = 1.0f, float height = 1.0f,
    float spd1 = 1.0f, float spd2 = 4.0f, float acc1 = 1.0f, float acc2 = 20.0f, float angle = 0.0f);
  void reset_particle_diamond(Vector3D pos, float width = 1.0f, float height = 1.0f,
    float spd1 = 1.0f, float spd2 = 4.0f, float acc1 = 1.0f, float acc2 = 20.0f, float angle = 0.0f);

  //CIRCLE
  void run_particle_circle(float dt, float p_lifetime, float lifetime_invariant, Vector3D pos, float radius = 1.0f,
    float spd1 = 1.0f, float spd2 = 4.0f, float acc1 = 1.0f, float acc2 = 20.0f, float angle = 0.0f, float spin = 0.0f, float spin_invariance = 0.0f);
  void reset_particle_circle(Vector3D pos, float p_lifetime, float radius = 1.0f,
    float spd1 = 1.0f, float spd2 = 4.0f, float acc1 = 1.0f, float acc2 = 20.0f, float angle = 0.0f, float new_spin = 0.0f);
