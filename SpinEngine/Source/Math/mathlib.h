...
{
public:
	ZilchDeclareBaseType(Vector2D, Zilch::TypeCopyMode::ReferenceType);
  float x;
  float y;
private:
...
{
public:
	ZilchDeclareBaseType(Vector3D, Zilch::TypeCopyMode::ReferenceType);
  float x;
  float y;
  float z;
private:
...
{
public:
	ZilchDeclareBaseType(Vector4D, Zilch::TypeCopyMode::ReferenceType);
  float x;
  float y;
  float z;
  float w;
...
public:
  ...
  static float ApproxATan(Vector3D input);
  ...
  static Vector3D RotateAroundPoint(Vector3D origin, float radAngle, Vector3D start);
  static Vector3D ApproxRotateAroundPoint(Vector3D origin, float radAngle, Vector3D start);

  //Josh's Easing functions
  //Linear
  static float Linear(float currentTime, float startValue, float endValue, float duration);

  //Quadratic
  static float QuadIn(float currentTime, float startValue, float endValue, float duration);
  static float QuadOut(float currentTime, float startValue, float endValue, float duration);
  static float QuadInOut(float currentTime, float startValue, float endValue, float duration);

  //Cubic
  static float CubicIn(float currentTime, float startValue, float endValue, float duration);
  static float CubicOut(float currentTime, float startValue, float endValue, float duration);
  static float CubicInOut(float currentTime, float startValue, float endValue, float duration);

  //Quartic
  static float QuarticIn(float currentTime, float startValue, float endValue, float duration);
  static float QuarticOut(float currentTime, float startValue, float endValue, float duration);
  static float QuarticInOut(float currentTime, float startValue, float endValue, float duration);

  //Quintic
  static float QuinticIn(float currentTime, float startValue, float endValue, float duration);
  static float QuinticOut(float currentTime, float startValue, float endValue, float duration);
  static float QuinticInOut(float currentTime, float startValue, float endValue, float duration);
