...
local libs = { "AntTweakBar", "d3dx9", "d3d9"} --add libs here
...
local solution_name = "SpinningChairs" -- there must not be any space for the os.remove to work properly
local engine_name = "Engine"
